#define BLYNK_TEMPLATE_ID "TMPL6aT5E7LmB"
#define BLYNK_TEMPLATE_NAME "Fan Speed control"
...
char auth[] = "q58BWBd2IRw7gAHA9HUwDrkc4jGOUb_B";
char ssid[] = "AEH_E_S5_506";
char pass[] = "77324887";
...
void loop()
{
  ...
  {
    FAN.on();
    int fanSpeedPercent = map(temp, threshold, 45, 10, 100);
